...
function Footer() {
    // we can write all the style in a single place by using the function
    const linkStyle = {
        textDecoration: "none",
        display: "block",
        marginBottom: "-12px", // Use positive margin for spacing
        color: "#666",
        ...
        <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className='container border-top mt-5' >
                <div className='row mt-5'>
                    ...
                    {/* all the cols will take equal size when we assign col for all */}
                    {/* this is img section  */}
                    <div className='col'>
                ...
                <div className='footer' style={{ marginTop: "70px", color: "#9b9b9b" }}>
                    {/* this is for last para */}
                    <p>
                    ...
                    <p>
                        ...
                        <a rel="nofollow" href="https://scores.sebi.gov.in/" target="_blank">SEBI SCORES</a>
                        :
                    ...
                    <p>
                        <a rel="nofollow" href="https://smartodr.in/" target="_blank">Smart Online Dispute Resolution</a>
                        |
                        <a href="https://zerodha-common.s3.ap-south-1.amazonaws.com/Downloads-and-resources/Smart%20ODR%20info.pdf" target="_blank">Grievances Redressal Mechanism</a>
